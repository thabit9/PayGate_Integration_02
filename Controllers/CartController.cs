...
using PayGate_Integration_02.DataAccess;
...
namespace PayGate_Integration_02.Controllers
{
    //[Route("cart")]
    public class CartController : Controller
    {
        ...
        public async Task<JsonResult> GetRequest()
        {
            ...
            request.Add("RETURN_URL", $"{Request.Scheme}://{Request.Host}/cart/complete");
            ...
            request.Add("EMAIL",
                HttpContext.User.Identity.IsAuthenticated
                    ...
                    */
            request.Add("EMAIL", "thabit9@gmail.com");//user.ToString());
